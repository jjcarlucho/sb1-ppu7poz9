  ...
  const testimonials = [
    {
      ...
      content: "I was skeptical at first, but The GameChanger completely transformed my business. Within 30 days, I had my book written and published. Now I'm making $6,500/month on autopilot!",
      revenue: "$6,500/month",
      rating: 5
    },
    {
      ...
      content: "The templates alone are worth 10x the price. I followed the system exactly and my first book generated $8,200 in the first month. This is a game-changer!",
      revenue: "$8,200/month",
      rating: 5
    },
    {
      ...
      content: "As someone who struggled with writing, The GameChanger made it incredibly simple. The AI tools and templates helped me create a professional book that now generates $5,300 monthly.",
      revenue: "$5,300/month",
      rating: 5
    }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              These are just a few of the 1,847+ success stories from students who took action with The GameChanger system
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-neutral-900 rounded-xl p-6 relative">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 opacity-50">
              {["Forbes", "Entrepreneur", "Inc.", "Business Insider", "HuffPost"].map((brand, index) => (
