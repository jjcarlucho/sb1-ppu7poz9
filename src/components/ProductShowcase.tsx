...
import { Star, Headphones, Sparkles, FileText, CheckCircle2, Gift } from 'lucide-react';
  ...
  const bonuses = [
    {
      ...
      value: "$97",
      description: "The ultimate guide to AI tools for content creation. Know exactly which tools to use for every task.",
    ...
    },
    {
      ...
      value: "$10,000",
      description: "Legendary manifestation audios that help you attract business opportunities on autopilot.",
    ...
    },
    {
      ...
      value: "$997",
      description: "Release subconscious blocks holding you back from charging premium prices.",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                The Complete GameChanger System For Turning Knowledge Into Income
              </h2>
              <p className="text-gray-300 mb-8">
                Get the exact blueprint I used to generate $27M+ in revenue with a single book—including templates, scripts, and step-by-step tutorials.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-white font-semibold">The GameChanger Method™ (Value: $197)</p>
                    <p className="text-gray-400 text-sm">Step-by-step system to write, publish & profit</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-green-400 flex-shrink-0 mt-1" />
                  <div>
                    <p className="text-white font-semibold">Done-For-You Templates (Value: $297)</p>
                    <p className="text-gray-400 text-sm">Book outlines, sales pages, email sequences</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-green-400 flex-shrink-0 mt-1" />
                  <div>
                    <p className="text-white font-semibold">Private Community Access (Value: $497)</p>
                    <p className="text-gray-400 text-sm">Connect with 1,847+ successful authors</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-amber-500/10 to-amber-400/10 border border-amber-500/20 rounded-lg p-4">
                <p className="text-amber-400 font-semibold">
                  Total Core Value: <span className="line-through">$991</span> Your Investment Today: $11.11
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-amber-500/10 border border-amber-500/20 rounded-full px-6 py-2 mb-6">
              ...
              <span className="text-amber-400 font-semibold">LIMITED TIME BONUSES</span>
            </div>
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Plus, Get These $11,094 Bonuses FREE When You Order Today
            </h3>
            <p className="text-gray-400 max-w-2xl mx-auto">
              These aren't just random add-ons. Each bonus was specifically chosen to accelerate your success and eliminate common roadblocks.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {bonuses.map((bonus, index) => (
              <div key={index} className="bg-neutral-800/50 rounded-xl p-6 border border-neutral-700 hover:border-amber-500/50 transition-colors">
